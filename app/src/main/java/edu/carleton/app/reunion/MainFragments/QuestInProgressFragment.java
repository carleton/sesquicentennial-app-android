...
import edu.carleton.app.reunion.Constants;
...
import edu.carleton.app.reunion.POJO.Quests.Waypoint;
import edu.carleton.app.reunion.R;

import static edu.carleton.app.reunion.R.id.rel_layout_found_it_hint;
    ...
    private void checkIfClueFound(){
        ...
        if(mainActivity.checkIfGPSEnabled()) {
            ...
            if (curLocation != null) {
                ...
                Log.d("SetUserVIS","HighACCURARY");
                //There was an if without an else, sometimes gps can return null even is gps is enabled because it takes time to get
                mainActivity.buildAlertMessageNoHighAccuracyGps();
            }

        }else{
            Log.d("SetUserVIS","Second");
            mainActivity.buildAlertMessageNoGps();
        }
    }
